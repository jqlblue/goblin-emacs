...
;; **************************************************
;; (use-package eglot
;;   :hook ((c-mode c++-mode css-mode go-mode java-mode js-mode kotlin-mode python-mode rust-mode dart-mode php-mode ruby-mode web-mode) . eglot-ensure)
;;   :config
